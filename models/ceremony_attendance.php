...
class CeremonyAttendance implements IModel
{
    ...
    function __construct($ceremony_id, $student_fn, $accepted, $speach_status, $responsibility_status)
    {
        ...
        $this->speach_status = SpeachStatus::tryFrom($speach_status) ?? parse_speach_status($speach_status);
        $this->responsibility_status = ResponsibilityStatus::tryFrom($responsibility_status) ?? parse_responsibility_status($responsibility_status);
    }
