...
$meta = new MetadataComponent(
    ...
    [
        ...
        "$base_url/pages/ceremonies/edit_ceremony/script.js"
    ]
);
echo $meta->render();
        ...
        <form id="edit-form">
            <div class="form-entry-container">
                ...
                <input type="datetime-local" id="date" name="date" required required
                    value="<?= htmlspecialchars($ceremony_info['date'], ENT_QUOTES, 'UTF-8') ?>">
            </div>
            ...
            <div class="form-entry-container">
                ...
                <input type="number" id="graduation-year" name="graduation-year" placeholder="Година на завършване"
                    required value="<?= $ceremony_info['graduation_year'] ?>">
            </div>
            ...
            <div class="form-entry-container">
                ...
                <input type="text" id="responsible-robes" name="responsible-robes" placeholder="Факултетен номер"
                    required required
                    value="<?= htmlspecialchars($ceremony_info['responsible_robes'], ENT_QUOTES, 'UTF-8') ?>">
            </div>
            ...
            <div class="form-entry-container">
                ...
                <input type="text" id="responsible-signatures" name="responsible-signatures"
                    placeholder="Факултетен номер" required required
                    value="<?= htmlspecialchars($ceremony_info['responsible_signatures'], ENT_QUOTES, 'UTF-8') ?>">
            </div>

            <div class="form-entry-container">
                <label class="form-label">Студент, отговорник по връчване на дипломите: </label>
                <input type="text" id="responsible-diplomas" name="responsible-diplomas" placeholder="Факултетен номер"
                    required required
                    value="<?= htmlspecialchars($ceremony_info['responsible_diplomas'], ENT_QUOTES, 'UTF-8') ?>">
            </div>
